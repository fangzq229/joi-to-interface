...
var _createInterface = function (file) { return __awaiter(void 0, void 0, void 0, function () {
    var intCon, _a, _b, _i, k, j, _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                intCon = '';
                if (!(file && typeof file === 'string')) return [3 /*break*/, 2];
                return [4 /*yield*/, Promise.resolve().then(function () { return require(file); }).then(function (res) { return __awaiter(void 0, void 0, void 0, function () {
                        var _a, _b, _i, k, j, _c;
                        return __generator(this, function (_d) {
                            switch (_d.label) {
                                case 0:
            ...
            case 1:
                ...
                return [3 /*break*/, 6];
            case 2:
                if (!(file && typeof file === 'object')) return [3 /*break*/, 6];
                _a = [];
                for (_b in file)
                    _a.push(_b);
                _i = 0;
...
var joiToInterface = function (joiObj) {
    if (joiObj === void 0) { joiObj = ''; }
    return __awaiter(void 0, void 0, void 0, function () {
        var interfaceCon_1, param, interfaceCon, file, oPath;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!(joiObj && typeof joiObj === 'object')) return [3 /*break*/, 2];
                    return [4 /*yield*/, _createInterface(joiObj)];
                case 1:
                    interfaceCon_1 = _a.sent();
                    return [2 /*return*/, interfaceCon_1];
                case 2:
                    ;
                    param = _checkParam();
                ...
                case 3:
                    ...
                    oPath = path.join(param.oPath, (file === null || file === void 0 ? void 0 : file.base) || "all.ts");
                    return [4 /*yield*/, _writeFile(oPath, interfaceCon)];
                case 4:
                    _a.sent();
                    return [2 /*return*/];
            }
